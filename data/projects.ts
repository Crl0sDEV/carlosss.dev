...
export const projects: Project[] = [
  {
    ...
    impact: "Eliminated $100+/mo in cloud storage costs for shop owners while maintaining 100% offline uptime during internet disruptions.",
  ...
  },
  {
    ...
    impact: "Reduced job application tracking turnaround by 60% with 0% data loss across active job seekers via offline-first sync.",
  ...
  },
  {
    ...
    impact: "Boosted digital booking inquiries by 35% in month 1 and automated pickup scheduling for local customers.",
  ...
  },
  {
    ...
    impact: "Achieved sub-second page loads (<0.8s LCP) and 100% offline access for property agents conducting field walkthroughs.",
  ...
  },
  {
    ...
    impact: "Reduced daily meal decision fatigue by generating AI recipe options in under 1.8 seconds with 95%+ user satisfaction.",
  ...
  },
  {
    ...
    impact: "Eliminated 100% of manual paper tracking errors and accelerated customer debt collection for local sari-sari store owners.",
  ...
  },
  {
    ...
    impact: "Increased ATS resume pass rates by providing instant automated keyword scoring in under 3 seconds.",
  ...
  },
  {
    ...
    impact: "Cut checkout drop-off rate by 25% through zero-latency Zustand cart state management and instant UI feedback.",
  ...
  },
  {
    ...
    impact: "Achieved fluid 60fps physics animations while maintaining a 100/100 Google PageSpeed Insights performance score.",
  ...
  },
  {
    ...
    impact: "Saved over 500+ collective hours of student brainstorming by generating verified IT project titles in under 2 seconds.",
  ...
  },
  {
    ...
    impact: "Delivered 24/7 real-time telemetry updates with sub-second alert latency to warn local communities of rising flood levels.",
  ...
  },
  {
    ...
    impact: "Provided local emergency responders with instant mobile alert notifications, cutting hazard reporting delay by 80%.",
    link: null,
  ...
  },
  {
    ...
    impact: "Boosted customer repeat visits by 40% through instant RFID card taps and automated reward point calculations.",
  ...
  },
  {
    ...
    impact: "Achieved real-time GPS telemetry updates under 500ms, giving campus administrators 100% vehicle visibility.",
    link: null,
  ...
  },
  {
    ...
    impact: "Engineered a 100/100 PageSpeed web app with custom AI micro-interactions that tripled recruiter engagement time.",
