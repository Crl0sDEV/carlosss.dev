...
export const projects: Project[] = [
  ...
  },
  {
    ...
    impact: "Streamlined the application process for active users, resulting in higher interview follow-up rates and better organization.",
  ...
  },
  {
    ...
    impact: "Modernized local presence, increasing digital bookings and online visibility for the local business.",
  ...
  },
  {
    ...
    impact: "Delivered a premium digital experience that retains 100% functionality offline, improving agent workflow.",
  ...
  },
  {
    ...
    impact: "Reduced decision fatigue for users by generating actionable meal plans in under 2 seconds.",
  ...
  },
  {
    ...
    impact: "Eliminated paper tracking errors, helping store owners recover unpaid debts with 100% data accuracy.",
  ...
  },
  {
    ...
    impact: "Increased resume quality by providing instant, automated ATS-compatibility scoring and feedback.",
  ...
  },
  {
    ...
    impact: "Delivered a frictionless checkout experience, minimizing cart abandonment through instant state updates.",
  ...
  },
  {
    ...
    impact: "Demonstrated advanced frontend capabilities by achieving 60fps animations without dropping performance.",
  ...
  },
  {
    ...
    impact: "Saved hundreds of collective student hours by automating the brainstorming phase of capstone formulation.",
  ...
  },
  {
    ...
    impact: "Provided crucial real-time hazard data, enabling faster disaster response and community safety.",
  ...
  },
  {
    ...
    impact: "Ensured uninterrupted mobile access to critical flood data for authorities in the field.",
    link: null,
  ...
  },
  {
    ...
    impact: "Increased customer retention by gamifying the loyalty experience with a seamless hardware-to-cloud integration.",
  ...
  },
  {
    ...
    impact: "Enhanced campus security and parent peace of mind through accurate, real-time vehicular tracking.",
    link: null,
  ...
  },
  {
    ...
    impact: "Served as a live technical showcase that dramatically increased client conversion and professional credibility.",
