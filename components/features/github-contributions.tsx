...
export function GithubContributions() {
  ...
  return (
    <div className="bg-white dark:bg-[#1A1A1A] p-6 rounded-xl border border-[#E4E4E7] dark:border-[#27272A] shadow-sm flex flex-col gap-6 mt-8">
      ...
      <div className="w-full overflow-x-auto pb-3 pt-1 scrollbar-thin flex justify-center">
